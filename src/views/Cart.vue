  ...
  <main>
    <div class="container">
      ...
      <div class="row pt-5 pb-3 border-bottom border-2">
          ...
          <span class="col-md-2 text-center text-dark d-none d-md-block">수량</span>
          <span class="col-md-2 text-center text-dark d-none d-md-block">가격</span>
          <span class="col-md-2 text-center text-dark d-none d-md-block">배송비</span>
      </div>

      <div class="row border-bottom border-2 pt-3 pb-3">
          <div class="col-2 col-md-2 col-lg-2 col-xl-1">
            <a class="align-self-center" style="cursor:pointer;"><img src="https://contents.sixshop.com/uploadedFiles/48764/product/image_1620794006376.jpg" class="img-fluid"></a>
          </div>

          <div class="col-md-4 col-lg-4 col-xl-5 align-self-center d-none d-md-block">
            <div class="align-self-center pb-3 text-dark" style="text-align: left;">국산 햇양파 10kg</div>
            <div style="cursor:pointer;">삭제하기</div>
          </div>
          <div class="col-md-2 align-self-center d-none d-md-block">           
              <div class="input-group d-flex justify-content-center">
                <span class="input-group-text text-center align-self-center" style="cursor: pointer; max-width:30px;">-</span>
                <input type="text" class="form-control text-center align-self-center" style="max-width:35px;" v-model="total">
                <span class="input-group-text text-center" style="cursor: pointer; max-width:30px;">+</span>            
              </div>          
          </div>        
          <span class="col-md-2 align-self-center text-center text-dark d-none d-md-block">21,900원</span>
          <span class="col-md-2 align-self-center text-center text-dark d-none d-md-block">2,500원</span>

          <div class="col-8 align-self-center d-md-none"> <!-- 모바일 화면에서의 ui -->
            <div class="align-self-center pb-1 text-dark" style="text-align: left;">국산 햇양파 10kg</div>
            <div class="d-md-none">
              <div class="input-group">
                <span class="input-group-text text-center" style="cursor: pointer; max-height: 30px;">-</span>
                <input type="text" class="form-control text-center" style="max-width:35px; max-height: 30px;" v-model="total">
                <span class="input-group-text text-center" style="cursor: pointer; max-height: 30px;">+</span>
              </div>
            </div>
            <div class="row pt-1">
      ...
      <div class="row pt-4">  
          <div class="mb-4 col-md-9 text-end d-none d-md-block text-dark">상품합계</div>         
          <div class="col-md-3 text-end d-none d-md-block text-dark">41,900원</div>          
          <div class="mb-1 col-md-9 text-end d-none d-md-block text-dark">배송비</div>          
      ...
      <div class="row pb-5">
        <span class="col-md-9 text-end text-dark fw-bolder d-none d-md-block">합계</span>       
        <span class="col-md-3 text-end text-dark fw-bolder d-none d-md-block">49,400원</span>
        <span class="col-6 text-dark fw-bolder d-md-none">합계</span>   
        <span class="col-6 text-end text-dark fw-bolder d-md-none">49,400원</span>
      </div>  
      <div class="row pb-5">
        <span class="col-6 col-md-6 d-flex flex-row-reverse">
          <button type="button" class="btn btn-outline-primary fw-bolder p-3">쇼핑 계속하기</button>
        </span>
        <span class="col-6 col-md-6">
          <button type="button"  class="btn btn-primary fw-bolder p-3">주문하기</button>
        </span>
      </div>    
    </div>
  </main>
